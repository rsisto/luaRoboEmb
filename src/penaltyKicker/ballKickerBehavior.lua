...
local ballKickerBehavior ={
  ...
  robotSpeed = 1000, -- rotation speed to search for ball
	ballAngleThreshold = 2, -- kicks if ball is between [50-ballAngleThreshold, 50 +ballAngleThreshold ], value between 1 and 50
  msKeepKicking = 5000, -- ms the robot will keep pushing the ball if the posts are not seen any more.
...
function ballKickerBehavior:actionStep()
	...
	ballKickerBehavior.debugprint('ballKickerBehavior:actionStep() speed: ' .. self.robotSpeed)
end
